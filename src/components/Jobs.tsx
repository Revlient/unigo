                    ...
                    >
                        {jobs.map((job) => (
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className="h-full p-6 bg-[#141414] rounded-3xl border-2 border-white/5 hover:border-blue-500/30 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 hover:-translate-y-1 flex flex-col">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-3">
                                            <span className="inline-flex items-center gap-1 text-xs font-medium text-gray-400 bg-white/5 px-2.5 py-1 rounded-lg">
                                    ...
                                    <motion.button
                                        ...
                                        className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-blue-600/25 transition-all duration-300"
